    ...
    <>
      <div className="cus-container">
        ...
        <Swiper
          ...
          navigation={{
            nextEl: ".button-next-slide-tv",
            prevEl: ".button-prev-slide-tv",
          }}
          pagination={{
            clickable: true,
          }}
      ...
      <div className="flex justify-between mx-[15px] md:mx-4 lg:mx-12 2xl:mx-20 relative bottom-[350px] md:bottom-[370px] z-20">
        <div className="button-prev-slide-tv bg-white w-fit md:p-3 rounded-full bg-opacity-10 hover:bg-opacity-30">
          <img src={leftArrow} alt="" />
        </div>
        <div className="button-next-slide-tv bg-white w-fit md:p-3 rounded-full bg-opacity-10 hover:bg-opacity-30">
